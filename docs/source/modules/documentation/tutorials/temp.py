    ...
    for name, layer in trial_model.named_modules():
        if isinstance(layer, torch.nn.Linear):
            ...
            if new_layer_cls == LinearInteger:
                ...
                chosen_width = bits_width[trial.suggest_int("bits_width", 0, 2)]
                chosen_exponent = exponent_width[trial.suggest_int("exponent_width", 0, 2)]
                ...
                bias_width = [-1, 0, 1]
                chosen_width = bits_width[trial.suggest_int("bits_width", 0, 2)]
                chosen_bias = bias_width[trial.suggest_int("bias_width", 0, 2)]
                kwargs["config"] = {
                    "data_in_width": chosen_width,
                    "data_in_exponent_bias": chosen_bias,
                    "weight_width": chosen_width,
                ...
                chosen_width = bits_width[trial.suggest_int("bits_width", 0, 2)]
                chosen_exponent = exponent_width[trial.suggest_int("exponent_width", 0, 2)]
                chosen_block = block_size[trial.suggest_int("block_width", 0, 2)]
                ...
                chosen_width = bits_width[trial.suggest_int("bits_width", 0, 2)]
                chosen_block = block_size[trial.suggest_int("block_width", 0, 2)]
                chosen_exponent_bias = shared_exponent_bias[trial.suggest_int("shared_exponent_bias", 0, 2)]
                ...
                stochastic = bool([trial.suggest_int("stochastic", 0, 1)])
                bipolar = True
                kwargs["config"] = {
...
#     csv_filename = f"tut6_{layer_names}_search.csv"
# else:
