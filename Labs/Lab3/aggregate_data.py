...
plt.axhline(y=baseline_accuracy, color="cornflowerblue", linestyle="dashed", linewidth=2, label="Baseline With Comp", alpha=0.75)
plt.axhline(y=0.88160, color="mediumpurple", linestyle="dashed", linewidth=2, label="Baseline Without Comp", alpha=0.75)
